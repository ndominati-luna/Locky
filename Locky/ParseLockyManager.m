...
#import "ParseLockyManager.h"
#import "LocalDevice.h"

@interface ParseLockyManager ()

@end

@implementation ParseLockyManager

+ (id)sharedInstance
{
	static ParseLockyManager *sharedInstance = nil;
	static dispatch_once_t onceToken;
	dispatch_once(&onceToken, ^{
		sharedInstance = [[ParseLockyManager alloc] init];
	});
